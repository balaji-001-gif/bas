...
class MobileAppNotification(Document):
	def before_submit(self):
		onesignal_api_key = frappe.db.get_single_value('Bas Settings','onesignal_api_key')
		app_id = frappe.db.get_single_value('Bas Settings','onesignal_app_id')
		...
		if onesignal_api_key and app_id:
			...
			frappe.throw("OneSignal API Key or App ID not configured in Bas Settings")
